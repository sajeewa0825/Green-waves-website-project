        ...
        <div class="row ourteamRow">
          <div class="col-sm-6">
            <div className="leftRow">
              ...
              <div className="blacklineWedo ourteamline"></div>
              <div>
            ...
            <section>
              ...
              <h1>
                <div className="team-row">
                  <div className="teams">
                    <img
                      src="https://firebasestorage.googleapis.com/v0/b/green-waves-f1d66.appspot.com/o/pr1.png?alt=media&token=86701337-c0ea-4982-81e2-935ead2b22a3"
                      height="100px"
                      alt="profile1"
                    />
                    <h3>S.L.C.Hansika</h3>
                  ...
                  <div className="teams">
                    <img
                      src="https://firebasestorage.googleapis.com/v0/b/green-waves-f1d66.appspot.com/o/pr2.png?alt=media&token=2399ff2e-de3e-4e65-91e8-56cd2c85a1cd"
                      height="100px"
                      alt="profile2"
                    />
                  ...
                  <div className="teams">
                    <img
                      src="https://firebasestorage.googleapis.com/v0/b/green-waves-f1d66.appspot.com/o/pr3.png?alt=media&token=ae19a6d2-ef58-4fb0-8292-d9d6498a6229"
                      height="100px"
                      alt="profile4"
                    />
                    <h3>G.T.Lakshan</h3>
